...
const StartScreen: React.FC<StartScreenProps> = ({ onFileSelect, onTakePhoto }) => {
    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
            <label htmlFor="image-upload-start" className="relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-blue-600 rounded-full cursor-pointer group hover:bg-blue-500 transition-colors w-full sm:w-auto">
